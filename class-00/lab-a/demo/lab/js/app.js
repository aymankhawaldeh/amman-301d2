...
function displayPics(){
  ...
  // Cause when we use let we must do it inside its block not outside if we declare it inside block and called the command outside that will give us an error.
  console.log(viewed);
